 ...
 */
class BotCommandScopeAllChatAdministrators extends BotCommandScope implements FromArrayInterface, ToArrayInterface
{
    ...
    /**
     * @param string $type Scope type, must be *all\_chat\_administrators*
     */
