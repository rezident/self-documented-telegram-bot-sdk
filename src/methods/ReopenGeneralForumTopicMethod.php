 ...
 * the chat for this to work and must have the *can\_manage\_topics* administrator rights. The topic will be
 ...
 */
class ReopenGeneralForumTopicMethod implements ToArrayInterface
{
