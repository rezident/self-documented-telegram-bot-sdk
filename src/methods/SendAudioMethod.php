 ...
 * must be in the .MP3 or .M4A format. On success, the sent [Message](https://core.telegram.org/bots/api#message) is
...
class SendAudioMethod implements ToArrayInterface
{
    ...
    private function __construct(private int|string $chatId, private InputFile|string $audio)
    {
    }
     ...
     *                           `@channelusername`)
     * @param InputFile|string $audio Audio file to send. Pass a file\_id as String to send an audio file that exists
